...
type OmitEventListenerTogglers<T> = Omit<
  T,
...
interface html_element
  extends _element,
    OmitEventListenerTogglers<GlobalEventHandlers> {
  accessKey: string;
...
interface html_anchor
  extends html_element,
    html_hyperlink_utils,
    download,
    name,
    rel,
    target,
